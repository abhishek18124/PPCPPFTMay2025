...
int main() {
	...
	for (int x : v) { // range-based for loop // here elements of v[] are copied into x
		cout << x << " ";
	}

	cout << endl;

	for (auto x : v) { // range-based for loop // here elements of v[] are copied into x
		cout << x << " ";
	}

	cout << endl;

	for (int& x : v) { // range-based for loop // here x is reference to elements in v[]
		cout << x << " ";
	}

	cout << endl;

	for (auto& x : v) { // range-based for loop // here x is reference to elements in v[]
		cout << x << " ";
	}
